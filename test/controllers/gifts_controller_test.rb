...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { email: @gift.email, name: @gift.name, phone: @gift.phone, time: @gift.time, type: @gift.type }
    end
  ...
  test "should update gift" do
    patch :update, id: @gift, gift: { email: @gift.email, name: @gift.name, phone: @gift.phone, time: @gift.time, type: @gift.type }
    assert_redirected_to gift_path(assigns(:gift))
  end
